      ...
      <div className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="mt-8 space-y-4 text-base leading-relaxed text-hs-muted">
          <p>
            ...
            Handshake Alerts). Handshake Alerts texts you about Handshake AI
            claimable tasks for projects you add and enable. It is not
            affiliated with Handshake.
          </p>
          <p>
            By signing in with your phone, you consent to receive SMS from
            Handshake Alerts as described on the sign-in page. Message frequency
